...
//Initialisation des positions d'entrée des éléments
...
//Initialisation des positions de sortie des éléments
...
double b1(1.2); // Intensité des quadrupoles
double b2(-1.2); // Intensité des quadrupoles
double re(0.1); // Rayon des chambres de l'accelerateu
double k(1); // Inverse du rayon de courbure
...
int main()
{
	...
	// Ajout des éléments de l'accélérateur
...
//----------------------------------------------------------------------
    ...
    Particule particule1(position1,axe1,force1,0.938272, 1.60217653e-19,2, (acc.get_collection_el())[2]);
    Particule particule2(position2,axe2,force2,0.938272, 1.60217653e-19, 2, (acc.get_collection_el())[2]);

	// Ajout des Particules
    acc.ajouteParticule(particule1);
    acc.ajouteParticule(particule2);

//----------------------------------------------------------------------

	// Accélérateur sans évolution
    cout << acc << endl;
